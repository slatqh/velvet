    ...
    return (
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={{ flex: 1 }}>
            ...
            <View style={styles.circlesContainer}>
              <View style={{ justifyContent: 'center', alignContent: 'center', flex: 1 }}>
                ...
                <CircleText
                  ...
                  name='FASHION'
                  id='170' userCategory={this.props.preferred}
                  onSelect={(selected) => this.category(170, selected)}
                />
                <CircleText
                  style={[styles.smallCircle, styles.art]}
                  name='ART'
                  id='149' userCategory={this.props.preferred}
              ...
              <View style={{ marginLeft: -20, marginTop: 30, justifyContent: 'center', alignContent: 'center', flex: 1 }}>
                ...
                <CircleText
                  ...
                  name='BAG' id='477' userCategory={this.props.preferred}
              ...
              <View style={{ flexDirection: 'column' }}>
                <CircleText
                  ...
                  name='NEWS'
                  id='152' userCategory={this.props.preferred}
                  onSelect={(selected) => this.category(152, selected)}
                />
                <CircleText
                  style={[styles.mediumCircle, styles.watch]}
                  name='Watches'
                  id='2363' userCategory={this.props.preferred}
              ...
              <View style={{ flexDirection: 'column' }}>
                <CircleText
                  ...
                  name='Bespoke'
                  id='2066' userCategory={this.props.preferred}
                ...
                <CircleText
                  ...
                  name='Grooming'
                  id='2213' userCategory={this.props.preferred}
          ...
          <View style={{ flex: 1, paddingHorizontal: 15, justifyContent: 'flex-end' }}>
            <CustomButton
              title='CONTINUE'
              color={Colors.black}
